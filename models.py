...
class ContainerChallengeModel(Challenges):
    ...
    ports = db.Column(db.Text, default='[]')  # JSON list of port numbers the container listens on.
...
class ContainerInfoModel(db.Model):
    ...
    ports = db.Column(db.Text, default='{}')  # Port number for the container instance.
