...
class ContainerManager:
    ...
    @run_command
    def create_container(self, image: str, port_bindings, command: str, volumes: str):
        """
    ...
    @run_command
    def get_container_port(self, container_id: str, internal_port) -> "str|None":
        """
  ...
  try:
   return ports[f'{internal_port}/tcp'][0]['HostPort']
            return None
